...
- กำหนดความกว้างคอลัมน์ตารางแยกกันได้ด้วย "จำนวนขีด" ในแถวคั่นหัวตาราง เช่น `| - | -------- | --- |` ทำให้คอลัมน์กลางกว้างกว่า มีผลทั้ง preview และ PDF (ขีดเท่ากันทุกคอลัมน์ = กว้างเท่ากันเหมือนเดิม)
- รูปภาพและสมการ LaTeX ฝังเป็นภาพความละเอียดสูงในโหมดข้อความ
- PDF export เป็น text layer คัดลอกข้อความได้ และเก็บ hyperlink จาก Markdown
- รองรับสมการ LaTeX ด้วย KaTeX ทั้งแบบ block `$$...$$` และ inline `$...$` ถูกเรนเดอร์เป็นภาพความละเอียดสูงที่หน้าตาตรงกับ preview — สมการ inline วางในบรรทัดตรงแกนคณิตศาสตร์ และบรรทัดจะขยายความสูงเองถ้าสมการสูงกว่าข้อความ
